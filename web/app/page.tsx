  ...
  return (
    <>
      <h1 className="mt-10 font-serif text-3xl leading-tight font-semibold sm:text-4xl">
        Understand US naturalization requirements.
      </h1>
      <p className="mt-4 text-lg text-muted">
        Every answer is written only from {documents} official documents: {uscis} chapters of the
        USCIS Policy Manual and {caselaw} federal court opinions. Each claim links to the passage
        it came from.
      </p>
      ...
      <p className="mt-4 rounded border border-flag/25 bg-flag/5 p-3 text-sm text-ink">
