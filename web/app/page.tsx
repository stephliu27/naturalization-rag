  ...
  return (
    <>
      ...
      <p className="mt-4 text-lg text-muted">
        Ask a question in your own words. The answer is written only from{" "}
        {documents} official documents — {uscis} chapters of the USCIS Policy Manual and{" "}
        {caselaw} federal court opinions — and every claim links to the exact passage behind it,
      ...
      <p className="mt-4 rounded border border-rule bg-white/60 p-3 text-sm text-muted">
        <strong className="font-medium text-ink">It does not make sources up.</strong> Across{" "}
        {answers} answers written during testing, all {citations} citations pointed at a real
        passage and{" "}
      ...
      <p className="mt-3 rounded border border-flag/25 bg-flag/5 p-3 text-sm text-ink">
        ...
        out names, case numbers, A-numbers, and details about your own situation — ask about the
        rule, not about yourself.
      </p>
